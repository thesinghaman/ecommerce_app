...
class ADummyData {
  ...
  static final List<BannerModel> banners = [
    BannerModel(
        imageUrl: AImages.banner1, targetScreen: ARoutes.order, active: false),
    BannerModel(
        imageUrl: AImages.banner2, targetScreen: ARoutes.cart, active: true),
    BannerModel(
        imageUrl: AImages.banner3,
        targetScreen: ARoutes.favourites,
        active: true),
    BannerModel(
        imageUrl: AImages.banner4, targetScreen: ARoutes.search, active: true),
    BannerModel(
        imageUrl: AImages.banner5,
        targetScreen: ARoutes.settings,
        active: true),
    BannerModel(
        imageUrl: AImages.banner6,
        targetScreen: ARoutes.userAddress,
        active: true),
    BannerModel(
        imageUrl: AImages.banner8,
        targetScreen: ARoutes.checkout,
        active: false),
  ];
  ...
  static final List<CategoryModel> categories = [
    CategoryModel(
        id: '1', image: AImages.sportIcon, name: 'Sports', isFeatured: true),
    CategoryModel(
        id: '5',
    ...
    CategoryModel(
        ...
        isFeatured: true),
    CategoryModel(
        id: '3', image: AImages.clothIcon, name: 'Clothes', isFeatured: true),
    CategoryModel(
        id: '4', image: AImages.animalIcon, name: 'Animals', isFeatured: true),
    CategoryModel(
        id: '6', image: AImages.shoeIcon, name: 'Shoes', isFeatured: true),
    CategoryModel(
        id: '7',
  ...
  static final List<ProductModel> products = [
    ProductModel(
      ...
      price: 135,
      isFeatured: true,
      thumbnail: AImages.productImage1,
      ...
      images: [
        ...
        AImages.productImage23,
        AImages.productImage21,
        AImages.productImage9
      ],
      salePrice: 30,
      sku: 'ABR4568',
      categoryId: '1',
    ...
    ProductModel(
      ...
      price: 35,
      isFeatured: true,
      thumbnail: AImages.productImage69,
      description:
          'This is a Product description for Blue Nike Sleeve less vest. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '6', image: AImages.zaraLogo, name: 'ZARA'),
      images: [
        AImages.productImage68,
        AImages.productImage69,
    ...
    ProductModel(
      ...
      price: 38000,
      isFeatured: false,
      thumbnail: AImages.productImage64,
      description:
      ...
      brand: BrandModel(id: '6', image: AImages.zaraLogo, name: 'ZARA'),
      images: [
        AImages.productImage64,
        AImages.productImage65,
        AImages.productImage66,
        AImages.productImage67
      ],
      salePrice: 30,
      sku: 'ABR4568',
      categoryId: '16',
    ...
    ProductModel(
      ...
      price: 135,
      isFeatured: false,
      thumbnail: AImages.productImage60,
      description:
      ...
      brand: BrandModel(id: '6', image: AImages.zaraLogo, name: 'ZARA'),
      images: [
        AImages.productImage60,
        AImages.productImage61,
        AImages.productImage62,
        AImages.productImage63
      ],
      salePrice: 30,
      sku: 'ABR4568',
      categoryId: '16',
    ...
    ProductModel(
      ...
      price: 35,
      isFeatured: false,
      thumbnail: AImages.productImage10,
      description:
      ...
      brand: BrandModel(
          ...
          isFeatured: true),
      images: [
        AImages.productImage7,
        AImages.productImage8,
        AImages.productImage9,
    ...
    ProductModel(
      ...
      price: 750,
      isFeatured: false,
      thumbnail: AImages.productImage11,
      description:
          'SAMSUNG Galaxy S9 (Pink, 64 GB)  (4 GB RAM), Long Battery timing',
      brand: BrandModel(id: '7', image: AImages.appleLogo, name: 'Samsung'),
      images: [
        AImages.productImage11,
        AImages.productImage12,
        AImages.productImage13,
        AImages.productImage12
      ],
      salePrice: 650,
      sku: 'ABR4568',
    ...
    ProductModel(
      ...
      price: 20,
      isFeatured: false,
      thumbnail: AImages.productImage18,
      description:
      ...
      brand: BrandModel(id: '7', image: AImages.appleLogo, name: 'Tomi'),
      salePrice: 10,
      sku: 'ABR4568',
      categoryId: '4',
      productAttributes: [
    ...
    ProductModel(
      ...
      price: 400,
      isFeatured: false,
      thumbnail: AImages.productImage19,
      description:
      ...
      brand: BrandModel(id: '1', image: AImages.nikeLogo, name: 'Nike'),
      images: [
        AImages.productImage19,
        AImages.productImage20,
        AImages.productImage21,
        AImages.productImage22
      ],
      salePrice: 200,
      sku: 'ABR4568',
      categoryId: '8',
    ...
    ProductModel(
      ...
      stock: 15,
      price: 400,
      thumbnail: AImages.productImage20,
      description:
          'This is a Product description for Nike Air Jordon. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '1', image: AImages.nikeLogo, name: 'Nike'),
      images: [
    ...
    ProductModel(
      ...
      price: 600,
      isFeatured: true,
      thumbnail: AImages.productImage21,
      description:
    ...
    ProductModel(
      ...
      price: 600,
      isFeatured: false,
      thumbnail: AImages.productImage22,
      description:
    ...
    ProductModel(
      ...
      price: 600,
      isFeatured: false,
      thumbnail: AImages.productImage23,
      description:
    ...
    ProductModel(
      ...
      price: 500,
      isFeatured: true,
      thumbnail: AImages.productImage26,
      description:
      ...
      brand: BrandModel(id: '1', image: AImages.nikeLogo, name: 'Nike'),
      images: [
        AImages.productImage26,
        AImages.productImage24,
        AImages.productImage25,
        AImages.productImage27
      ],
      // salePrice: 400,
      sku: 'ABR4568',
      categoryId: '9',
    ...
    ProductModel(
      ...
      stock: 15,
      price: 200,
      thumbnail: AImages.productImage24,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 100,
      thumbnail: AImages.productImage25,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 350,
      thumbnail: AImages.productImage27,
      description:
    ...
    ProductModel(
      ...
      price: 40,
      isFeatured: true,
      thumbnail: AImages.productImage28,
      description:
      ...
      brand: BrandModel(id: '2', image: AImages.adidasLogo, name: 'Adidas'),
      images: [
        AImages.productImage28,
        AImages.productImage29,
        AImages.productImage30,
        AImages.productImage31
      ],
      // salePrice: 400,
      sku: 'ABR4568',
      categoryId: '10',
    ...
    ProductModel(
      ...
      stock: 15,
      price: 30,
      thumbnail: AImages.productImage29,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 25,
      thumbnail: AImages.productImage30,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 54,
      thumbnail: AImages.productImage31,
      description:
    ...
    ProductModel(
      ...
      price: 950,
      isFeatured: true,
      thumbnail: AImages.productImage32,
      description:
          'Flutter is Google’s mobile UI open source framework to build high-quality native (super fast) interfaces for iOS and Android apps with the unified codebase.',
      brand: BrandModel(id: '8', image: AImages.kenwoodLogo, name: 'Kenwood'),
      images: [
        AImages.productImage43,
        AImages.productImage44,
        AImages.productImage45,
        AImages.productImage46
      ],
      salePrice: 600,
      sku: 'ABR4568',
      categoryId: '11',
      ...
      productVariations: [
        ...
        ProductVariationModel(
            ...
            stock: 15,
            price: 35,
            image: AImages.productImage45,
            attributeValues: {'Color': 'Brown', 'Size': 'EU 32'}),
        ProductVariationModel(
            id: '3',
            stock: 14,
            price: 34,
            image: AImages.productImage46,
            attributeValues: {'Color': 'Brown', 'Size': 'EU 30'}),
        ProductVariationModel(
            id: '4',
            stock: 13,
            price: 33,
            image: AImages.productImage43,
            attributeValues: {'Color': 'Black', 'Size': 'EU 32'}),
        ProductVariationModel(
            id: '5',
            stock: 12,
    ...
    ProductModel(
      ...
      stock: 15,
      price: 25,
      thumbnail: AImages.productImage33,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 25,
      thumbnail: AImages.productImage34,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 56,
      thumbnail: AImages.productImage35,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 1012,
      thumbnail: AImages.productImage36,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 1012,
      thumbnail: AImages.productImage37,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 987,
      thumbnail: AImages.productImage38,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 150,
      thumbnail: AImages.productImage39,
      description:
      ...
      brand: BrandModel(id: '9', image: AImages.ikeaLogo, name: 'IKEA'),
      // salePrice: 400,1
      sku: 'ABR4568',
      categoryId: '13',
      productAttributes: [
    ...
    ProductModel(
      ...
      stock: 15,
      price: 140,
      thumbnail: AImages.productImage40,
      description:
          'This is a Product description for Office Chair. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '9', image: AImages.ikeaLogo, name: 'IKEA'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      stock: 15,
      price: 360,
      thumbnail: AImages.productImage41,
      description:
    ...
    ProductModel(
      ...
      stock: 15,
      price: 400,
      thumbnail: AImages.productImage42,
      description:
          'This is a Product description for Office Desk. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '9', image: AImages.ikeaLogo, name: 'IKEA'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      price: 950,
      isFeatured: true,
      thumbnail: AImages.productImage56,
      description:
      ...
      brand: BrandModel(id: '10', image: AImages.acerlogo, name: 'Acer'),
      images: [
        AImages.productImage56,
        AImages.productImage47,
        AImages.productImage57,
        AImages.productImage58
      ],
      salePrice: 800,
      sku: 'ABR4568',
      categoryId: '14',
      ...
      productVariations: [
        ...
        ProductVariationModel(
            ...
            stock: 15,
            price: 450,
            image: AImages.productImage47,
            attributeValues: {'Ram': '8', 'hard': '512'}),
        ProductVariationModel(
            id: '3',
            stock: 14,
            price: 470,
            image: AImages.productImage59,
            attributeValues: {'Ram': '8', 'hard': '1 tb'}),
        ProductVariationModel(
            id: '4',
            stock: 13,
            price: 500,
            image: AImages.productImage58,
            attributeValues: {'Ram': '16', 'hard': '512'}),
        ProductVariationModel(
            id: '5',
            stock: 12,
            price: 650,
            image: AImages.productImage57,
    ...
    ProductModel(
      ...
      stock: 15,
      price: 400,
      thumbnail: AImages.productImage48,
      description:
          'This is a Product description for Acer Laptop. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '10', image: AImages.acerlogo, name: 'Acer'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      stock: 15,
      price: 400,
      thumbnail: AImages.productImage49,
      description:
          'This is a Product description for Acer Laptop. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '10', image: AImages.acerlogo, name: 'Acer'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      stock: 15,
      price: 400,
      thumbnail: AImages.productImage50,
      description:
          'This is a Product description for Acer Laptop. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '10', image: AImages.acerlogo, name: 'Acer'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      stock: 15,
      price: 999,
      thumbnail: AImages.productImage51,
      description:
      ...
      brand: BrandModel(id: '5', image: AImages.appleLogo, name: 'Apple'),
      // salePrice: 400,1
      sku: 'ABR4568',
      categoryId: '15',
      productAttributes: [
    ...
    ProductModel(
      ...
      stock: 15,
      price: 999,
      thumbnail: AImages.productImage52,
      description:
          'This is a Product description for Iphone. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '5', image: AImages.appleLogo, name: 'Apple'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      stock: 15,
      price: 999,
      thumbnail: AImages.productImage53,
      description:
          'This is a Product description for Iphone. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '5', image: AImages.appleLogo, name: 'Apple'),
      // salePrice: 400,1
    ...
    ProductModel(
      ...
      price: 950,
      isFeatured: true,
      thumbnail: AImages.productImage70,
      description:
      ...
      brand: BrandModel(id: '5', image: AImages.appleLogo, name: 'Apple'),
      images: [
        AImages.productImage70,
        AImages.productImage71,
        AImages.productImage72,
        AImages.productImage73
      ],
      salePrice: 800,
      sku: 'ABR4568',
      categoryId: '15',
    ...
    ProductModel(
      ...
      brand: BrandModel(id: '5', image: AImages.appleLogo, name: 'iphone 8'),
      images: [
        AImages.productImage15,
        AImages.productImage16,
        AImages.productImage17,
        AImages.productImage14
      ],
      salePrice: 380,
      sku: 'ABR4568',
      categoryId: '4',
  ...
  static final List<ProductReviewModel> productReviews = [
    ProductReviewModel(
      ...
      userImageUrl: AImages.userProfileImage2,
      comment:
    ...
    ProductReviewModel(
      ...
      timestamp: DateTime.now(),
      companyTimestamp: DateTime.now(),
      userImageUrl: AImages.userProfileImage1,
      comment:
    ...
    ProductReviewModel(
      ...
      timestamp: DateTime.now(),
      companyTimestamp: DateTime.now(),
      userImageUrl: AImages.userProfileImage3,
      comment:
