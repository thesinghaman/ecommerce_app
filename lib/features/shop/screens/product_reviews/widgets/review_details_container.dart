    ...
    return Column(
      children: [
        ...
        Row(
          children: [
            ///Review Stars
            ARatingBarIndicator(rating: productReview.rating),

            ///Review Date
            const SizedBox(width: 10.0),
            Text(AFormatter.formatDate(productReview.timestamp)),
          ],
        ),
        const SizedBox(height: 10.0),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(AFormatter.formatDate(productReview.companyTimestamp)),
                  ],
                ),
                const SizedBox(height: 10.0),
